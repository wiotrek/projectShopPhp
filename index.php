            ...
            <div class="leftSide">
                <div class="borderPicture">
                        <?php
                            ...
                            echo "<img class='imgPicture' src=$getPicture>";
                        ?>
                </div>
            </div>
            <div class="rightSide">
                ...
                <div class="rsDescription">
                    ...
                    <p>
                        <input class='pluseOrder' type='button' value='+' />
                        <input type='text' class='countOrder' value='1' />
                        <input class='minuseOrder' type='button' value='-' />

                    </p>
                    <p>
                        <?php
                            echo "<a href='?site=$currentSite'>Nastepna strona</a>";        
                        ?>
                    </p>
                </div>
            </div>
